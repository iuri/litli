...
y						   null,
		...
		update evaluation_tasks set points=entry.points, relative_weight=entry.relative_weight, perfect_score= entry.perfect_score where task_id=v_task_revision_id;
