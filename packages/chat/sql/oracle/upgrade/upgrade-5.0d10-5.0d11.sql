...
alter table chat_rooms add login_messages_p char(1) default 't';
alter table chat_rooms add constraint chat_login_messaages_flush_ck check(login_messages_p in ('t','f'));

alter table chat_rooms add logout_messages_p char(1) default 't';
alter table chat_rooms add constraint chat_logout_messaages_flush_ck check(logout_messages_p in ('t','f'));
...
as
    ...
    begin
        update chat_rooms set
            ...
            login_messages_p  = chat_room.edit.login_messages_p,
            logout_messages_p = chat_room.edit.logout_messages_p	    
        where
